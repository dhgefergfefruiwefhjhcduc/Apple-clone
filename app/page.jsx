...
export default function Page() {
  ...
  const img = [
    {
      src: "/Brad-Pitt-F1-Poster-070524-fe9add0efa85450297b5f1d208ca9b79.jpg",
      alt: "Brad Pitt F1 Poster",
      type: "Action",
      text: "Coming to cinemas in 2025.",
    },
    {
      src: "/Apple-TV-Plus-Show-SEverance-Season-TWo-Balloon-Poster-Artwork.jpg",
      alt: "Severance Season Two Poster",
      type: "Thriller",
      text: " There’s more to work than life.",
    },
    {
      src: "/f09b8ea4b37ead4fec7438a46218f978.jpg",
      alt: "Image 3",
      type: "Sci-Fi",
      text: " To live, you need something to die for.",
    },
    {
      src: "/Apple_TV_debuts_trailer_for_highly_anticipated_season_two_of_Bad_Sisters_Big_Image_01_big_image_post.jpg.large.jpg",
      alt: "Bad Sisters Season Two Poster",
      type: "Drama",
      text: " Still killing it.",
    },
    {
      src: "/shrinking-cast-poster-1280x720.jpg",
      alt: "Shrinking Cast Poster",
      type: "Comedy",
  ...
  return (
    <>
      {more ?
        <div className={more ? 'downn h-screen w-full bg-black flex flex-col gap-y-5 p-10 ' : ' h-screen w-full bg-black flex flex-col gap-y-5 p-10'} >
          <div className='w-full flex justify-end'>
            <img onClick={handelmore} className='h-8 w-8' src='/close.svg' alt='close'></img>
          </div>
          <a href='#' className='text-[#c1c1c1] text-3xl font-bold'>Store</a>
          <a href='#' className='text-[#c1c1c1] text-3xl font-bold'>Mac</a>
          <a href='#' className='text-[#c1c1c1] text-3xl font-bold'>iPad</a>
          <a href='#' className='text-[#c1c1c1] text-3xl font-bold'>iPhone</a>
          <a href='#' className='text-[#c1c1c1] text-3xl font-bold'>Watch</a>
          <a href='#' className='text-[#c1c1c1] text-3xl font-bold'>AirPods</a>
          <a href='#' className='text-[#c1c1c1] text-3xl font-bold'>TV & Home</a>
          <a href='#' className='text-[#c1c1c1] text-3xl font-bold'>Entertainment</a>
          <a href='#' className='text-[#c1c1c1] text-3xl font-bold'>Accessories</a>
          <a href='#' className='text-[#c1c1c1] text-3xl font-bold'>Support</a>
        ...
        <div className="w-full min-h-screen bg-white">
          ...
          <div className='mob flex flex-col'>
            <nav className="flex h-[6vh] top-0 flex-col justify-between  z-30 items-center bg-gray-100 shadow-md fixed w-[100vw]">
              <div className='h-full w-full flex justify-between gap-9 items-center bg-black'>
                <img className='h-5 w-5 ml-5' alt='applelogo' src='/apple.svg'></img>
                <ul className='flex gap-7 text-xs text-[rgb(156,156,156)] font-semibold mr-5'>                  <img src='/search.svg' alt='search' className='cursor-pointer h-4 w-4'></img>
                  <img src='/cart.svg' alt='cart' className='cursor-pointer h-4 w-4'></img>
                  <img src='/more.svg' onClick={handelmore} alt='more' className='cursor-pointer h-4 w-4'></img>
                </ul>
              </div>
          ...
          <div className="w-full h-[96vh] hero flex items-center justify-center bg-black text-white text-center p-6">
            <div className='mt-[6.5rem]'>
              <h1 className="text-3xl relative md:text-5xl font-bold z-10">iPhone 16 Pro</h1>
              <p className="text-lg relative md:text-3xl mt-2 z-10">Built for Apple Intelligence</p>
              <img className='pc h-[60vh] w-[52vw] my-[-60px]' alt='img1' src='/Screenshot 2025-02-12 191508.png'></img>
              <img className='mob h-[33vh] w-[85vw]  my-[-10px] ' alt='img2' src='/store-card-40-iphone-16-pro-202409_FMT_WHH.jpg'></img>
          ...
          <div className="w-full mt-3 hero12 h-[98vh] grad flex items-center justify-center bg-black text-white text-center p-6">
            <div className='mt-[6.5rem] ext hero2'>
              <h1 className="text-4xl relative md:text-6xl font-semibold z-10">iPhone 16 </h1>
              <p className="text-lg relative md:text-3xl mt-2 z-10">Built for Apple Intelligence</p>
              <img className='pc h-[30vh] w-[52vw] my-[50px]' alt='img3' src='/hero_endframe__dtznvlokjeeu_xlarge.png'></img>
              <img className='mob h-[32vh] w-[25vw] my-[30px]' alt='img4' src='/hero_small_2x.png'></img>
          ...
          <div className="w-full mt-4 hero7 hero13 h-[98vh] flex items-center justify-center bg-[#f5f5f7] text-white text-center p-6">
            <div className='mt-[6.5rem] hero3'>
              ...
              <img className='pc h-[60vh] w-[52vw]' alt='img6' src='/Apple-Watch-Series-10-hero-240909_big.jpg.large-removebg-preview.png'></img>
              <img className='mob h-[35vh] w-[75vw]' alt='img7' src='/axz17moawmdbwd9n3i0kdsfsgu8mlpvt-removebg-preview.png'></img>
            </div>
          </div>
          <div className="w-full flex-wrap CARD mt-4 gap-x-3 gap-y-0 h-[248vh] pb-2 flex  justify-center  bg-[white] text-white text-center px-2">
            ...
            <div className="hover:scale-[1.02] transition-all duration-300 ease-in-out cursor-pointer w-[48vw] card mt-4 h-[80vh] flex items-center justify-center bg-[black] text-white text-center p-6">
              <div className='mt-[4.5rem] hero21 justify-center flex flex-col items-center'>
                <div className='flex justify-center items-center'>
                  <img src='/apple.svg' alt='img8' className='h-[40px] w-[40px]'></img>
                ...
                <img className='pc h-[50vh] w-[15vw] mt-5 mb-5' alt='img9' src='/Screenshot_2025-02-12_223427-removebg-preview.png'></img>
                <img className='mob h-[36vh] w-[48vw] mt-7' alt='img10' src='/Screenshot_2025-02-12_223427-removebg-preview.png'></img>
              </div>
            </div>

            <div className="hover:scale-[1.02] transition-all duration-300 ease-in-out cursor-pointer  w-[48vw] card mt-4 h-[80vh] flex items-center justify-center bg-[white] text-white text-center p-6 relative overflow-hidden">
            ...
            <div className="hover:scale-[1.02] transition-all duration-300 ease-in-out cursor-pointer  card w-[48vw] mt-4 h-[80vh] flex items-center justify-center bg-[#f5f5f7] text-white text-center p-6">
              ...
              <div className='mt-[6.5rem] hero3'>
                ...
                <img className='pc h-[52vh] w-[30vw] relative' alt='img13' src='/1-hero_static__c9sislzzicq6_large_2x-removebg-preview.png'></img>
                <img className='mob h-[30vh] w-[58vw] relative' alt='img14' src='/1-hero_static__c9sislzzicq6_large_2x-removebg-preview.png'></img>
              </div>
            </div>

            <div className="hover:scale-[1.02] transition-all duration-300 ease-in-out cursor-pointer  card w-[48vw] mt-4 h-[80vh] flex items-center justify-center bg-[black] text-white text-center p-6">
              <div className='mt-[4.5rem] hero3'>
                ...
                <button className="mt-6 px-4 py-2 bg-blue-600 text-white rounded-full hover:bg-blue-700 transition">Learn More</button>
                <button className="mt-6 ml-6 px-4 py-2 bg-[#ffffff00] border border-blue-600 text-blue-600 rounded-full hover:text-white hover:bg-blue-600">Buy</button>
                <img className='pc h-[15vh] mt-20 mb-20 w-[30vw] relative' alt='img15' src='/hero_endframe__sg50vzdd6sqm_large.jpg'></img>
                <img className='mob h-[8vh] mt-20 mb-20 w-[92vw] relative' alt='img16' src='/hero_endframe__sg50vzdd6sqm_large.jpg'></img>
                <p className='text-[rgb(156,156,156)] m-2 co'>Built for Apple Intelligence.</p>
                <p className='text-[rgb(156,156,156)] m-2'>Apple Intelligence available now in US English</p>
              </div>
            </div>

            <div className="hover:scale-[1.02] transition-all duration-300 ease-in-out cursor-pointer  card w-[48vw] mt-4 h-[80vh] flex items-center justify-center bg-[white] text-white text-center p-6 relative overflow-hidden">
              <div className='absolute inset-0'>
            ...
            <div className="hover:scale-[1.02] transition-all duration-300 ease-in-out cursor-pointer  card2 w-[48vw] mt-4 h-[80vh] flex items-center justify-center bg-[#f5f5f7] text-white text-center py-6">
              <div className='mt-[4.5rem] w-[48vw] her'>
                <div className='flex justify-center items-center'>
                  <img src='/apple2.svg' className='h-[40px] w-[40px]' alt='img19'></img>
                ...
                <img className='pc h-[50vh] w-full mt-5 mb-5' alt='img20' src='/Screenshot_2025-02-13_102249-removebg-preview.png'></img>
                <img className='mob h-[20vh] w-full mt-10 mb-5' alt='img21' src='/Screenshot_2025-02-13_102249-removebg-preview.png'></img>
              </div>
            </div>
          </div>


          <div id="default-carousel" className="relative w-full h-[100vh] carou" data-carousel="slide">
              ...
              {img.map((image, index) => (
                ...
                <div key={index} className="hidden duration-700 ease-in-out" data-carousel-item>
                  <img
                    ...
                    alt={image.alt}
                  />
                  <div className='pc1 flex-row flex z-20 absolute bottom-8 left-8 justify-center items-center gap-3'>
                    <button
                      className="h-10 w-30 p-2  bg-white rounded-full font-semibold text-black"
                    >
                      Stream now
                    </button>
                    <p className='font-bold text-2xl'>{image.type} :</p>
                    <p className='font-medium text-2xl'> {image.text}</p>
                  </div>
                  <div className='mob flex z-20 absolute bottom-4 left-4 justify-center items-center gap-3'>
                    <button
                      className="h-10 w-30 p-2  bg-white rounded-full font-semibold text-black"
                    >
                      Stream now
          ...
          <footer className="bg-[#f5f5f7] py-8 text-[12px] relative z-20 text-[#828282]">
            <div className="max-w-5xl mx-auto px-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
                <div>
                  <h1 className="text-xs font-semibold text-black mb-4">Shop and Learn</h1>
                ...
                <div>
                  <h1 className="text-xs text-black font-semibold mb-4">Account</h1>
                  <ul className="space-y-2">
                ...
                <div>
                  <h1 className="text-xs text-black font-semibold mb-4">Apple Store</h1>
                  <ul className="space-y-2">
                ...
                <div>
                  <h1 className="text-xs text-black font-semibold mb-4">For Business</h1>
                  <ul className="space-y-2">
                ...
                <div>
                  <h1 className="text-xs text-black font-semibold mb-4">Apple Values</h1>
                  <ul className="space-y-2">
              ...
              <pre className='w-full'>
                <p className=" text-gray-500 text-xs mt-6">Copyright © 2025 Apple Inc. All rights reserved.  <br></br>
                  <a href="#" className="hover:underline">Privacy Policy</a> | <a href="#" className="hover:underline">Terms of Use </a> | <a href="#" className="hover:underline">Sales Policy</a><br></br>
                  <a href="#" className="hover:underline">Legal</a> | <a href="#" className="hover:underline">Site Map</a>
                </p>
              </pre>
